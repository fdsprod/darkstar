...
export function RunReadinessPage() {
  ...
  return <div className="page detail-page readiness-page">
    ...
    {notice && <AsyncPanel compact state={notice.includes("changed") ? "stale" : "success"} title={notice.includes("changed") ? "State changed" : "Decision recorded"} message={notice} />}
    {error && <AsyncPanel compact state="error" title="Readiness action failed" message={error} />}
