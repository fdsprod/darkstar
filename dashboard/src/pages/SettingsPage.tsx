...
export function SettingsPage() {
  ...
  return <div className="page settings-page">
    ...
    {notice && <AsyncPanel compact state="success" title="Project registered" message={notice} />}
