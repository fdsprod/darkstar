...
export class DarkstarApiClient {
  ...
  listAttention(query: { kind?: Schemas["AttentionKind"]; projectId?: string; workItemId?: string; runId?: string; limit?: number; cursor?: string } = {}, signal?: AbortSignal) { return this.operation("getAttentionV2", { query, signal }); }
