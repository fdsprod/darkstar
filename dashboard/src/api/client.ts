...
export class DarkstarApiClient {
  ...
  startRun(runId: string, resourceVersion: number, idempotencyKey: string, assessmentDigest: string, signal?: AbortSignal) { return this.operation("startPreparedRun", { path: { runId }, body: { assessmentDigest }, resourceVersion, idempotencyKey, signal }); }
  ...
  decideAttention(kind: "workflow_control" | "external_delivery", approvalId: string, resourceVersion: number, idempotencyKey: string, body: Schemas["AttentionDecisionRequest"], signal?: AbortSignal) { return this.operation("decideAttention", { path: { kind, approvalId }, body, resourceVersion, idempotencyKey, signal }); }
  ...
  createCheckpointFeedbackSet(approvalId: string, resourceVersion: number, idempotencyKey: string, body: Schemas["CheckpointFeedbackSetDraftRequest"], signal?: AbortSignal) { return this.operation("createCheckpointFeedbackSet", { path: { approvalId }, body, resourceVersion, idempotencyKey, signal }); }
  submitCheckpointFeedbackSet(approvalId: string, feedbackSetId: string, resourceVersion: number, idempotencyKey: string, body: Schemas["CheckpointFeedbackSetSubmitRequest"], signal?: AbortSignal) { return this.operation("submitCheckpointFeedbackSet", { path: { approvalId, feedbackSetId }, body, resourceVersion, idempotencyKey, signal }); }
