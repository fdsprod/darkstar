...
export interface components {
  schemas: {
    ...
    "WorkflowCheckpointAttention": { "kind": "workflow_checkpoint"; "id": string; "context": components["schemas"]["AttentionContext"]; "urgency": number; "createdAt": string; "resourceVersion": number; "summary": string; "deepLink": string; "subject": { "checkpointId": string; "visitId": string; "nodeId": string; "attemptId": string; "revision": number; "candidateArtifactId": string; "candidateVersion": number; "candidateDigest": string; "mode": string; "scopeDigest": string; "policyDigest": string; }; "allowedActions": Array<"approve" | "request_changes" | "reject">; };
    "WorkflowControlAttention": { "kind": "workflow_control"; "id": string; "context": components["schemas"]["AttentionContext"]; "urgency": number; "createdAt": string; "resourceVersion": number; "summary": string; "deepLink": string; "subject": { "visitId"?: string; "nodeId"?: string; "attemptId"?: string; "scopeDigest": string; "policyDigest": string; }; "allowedActions": Array<"approve" | "deny" | "cancel">; };
