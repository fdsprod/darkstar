...
Workflow commands:
  ...
  workflow node-definition list [--query <text>] [--scope <built_in|project|user>] [--lifecycle <active|archived>] [--json]
  workflow node-definition create <definition.json> --idempotency-key <key> [--json]
  workflow node-definition duplicate <ref.json> <name> --version <version> --scope <project|user> --owner <id> --idempotency-key <key> [--json]
  workflow node-definition version <ref.json> <version> --idempotency-key <key> [--json]
  workflow node-definition archive <ref.json> --idempotency-key <key> [--json]
